...
extern CLOption<bool> shoc_flag, soc_flag, cs_flag, cop_flag;
...
void CheckAndSetupRenderer()
{
    ...
    static CLOption<bool> gl_flag("-rgl", "opengl renderer", false);
    static CLOption<bool> r4_flag("-r4", "r4 renderer", false);
    static CLOption<bool> r3_flag("-r3", "r3 renderer", false);
    static CLOption<bool> r25_flag("-r2.5", "r2.5 renderer", false);
    static CLOption<bool> r2a_flag("-r2a", "r2a renderer", false);
    static CLOption<bool> r2_flag("-r2", "r2 renderer", false);
    static CLOption<bool> r1_flag("-r1", "r1 renderer", false);
...
{
#ifdef DEBUG
    static CLOption<bool> slowdown_flag("-slowdown", "slowdown", false);
    static CLOption<bool> slowdown2x_flag("-slowdown2x", "slowdown2x", false);
